...
public class TestActivity1A
{
    ...
    public void checkWeatherMonth()
    {
        ...
        checkMethod("setDayMinTemp", "void", "int", "int");
        checkMethod("readMaxTempFile", "void", "String");
        checkMethod("readMinTempFile", "void", "String");
     ...
     */
    @Test
    public void checkWeatherComputation()
    {
        fail = false;
        
        //Check this class
        className = "WeatherComputation";
        ...
        checkStaticMethod("averageTemperature", "double", "int[]");
        checkStaticMethod("highestTemperature", "int", "int[]");
        checkStaticMethod("lowestTemperature", "int", "int[]");
        checkStaticMethod("numberMissing", "int", "int[]");
        checkStaticMethod("hdd", "double", "int", "int");
        checkStaticMethod("cdd", "double", "int", "int");
        checkStaticMethod("monthHdd", "double", "int[]", "int[]");
        checkStaticMethod("monthCdd", "double", "int[]", "int[]");
