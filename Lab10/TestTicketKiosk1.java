...
public class TestTicketKiosk1
{
    ...
    /**
     * Test the TicketKiosk class.
     */
    @Test
    public void checkTicketKiosk1()
    {
        fail = false;
        
        //Check this class
        className = "TicketKiosk";
        ...
        //checkMethod("equals", "boolean", "Customer");
        checkMethod("purchaseTickets", "void", "java.util.Scanner");
        checkMethod("findFlight", "Flight", "int");
        checkMethod("printSchedule", "void");
        checkMethod("readSchedule", "void");
        checkMethod("readOneFlight", "Flight", "java.util.Scanner");        

        if (fail)
        {
            //printGrade(4);
            fb += "Fail in TestTicketKiosk1.\n";
    ...
    {           
        ...
        try
        {                       
            Method method = testClass.getDeclaredMethod(name, typeArray);
