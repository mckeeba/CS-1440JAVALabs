...
public class VerifyRabbitPopulationClassDeclaration
{
    private String className = "RabbitPopulation";
    private String[] fields = new String[]
    {
        "initialPopulation", "int",
        "sixMonthPopulation", "int"
    };
    ...
    private HashMap<String, String[]> otherMethods =
        ...
        {
            {
                put("calculateGrowthRate", new String[] {"double"});
                put("calculate12MonthPopulation", new String[] {"int"});
            }
        };
     ...
     */
    public VerifyRabbitPopulationClassDeclaration()
    {
    }
