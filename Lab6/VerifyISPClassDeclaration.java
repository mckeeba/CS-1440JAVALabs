...
public class VerifyISPClassDeclaration
{
    private String className = "ISP";
    ...
    private HashMap<String, String[]> otherMethods =
        ...
        {
            {
                put("calculateCharges", new String[] {"double"});
            }
        };
     ...
     */
    public VerifyISPClassDeclaration()
    {
    }
    ...
    private void checkOtherMethods()
    {
        for (Map.Entry<String, String[]> e : otherMethods.entrySet())
        {
            ...
            {
                paramTypes = Arrays.copyOfRange(e.getValue(),
                    1, e.getValue().length);
            }
            else
            {
     ...
     */
    private void checkOneOtherMethod(String methodName,
        String retType, String... paramTypeNames)
    {
